...
*[CATENA](/blog/dilate-ensemble-presents-catena-counterpulse/)*, a non-looping visual and densely textured sound environment allows performers and audience members to experience livestreams from two different physical locations inside CounterPulse's Tenderloin District building, located in San Francisco.<!--excerpt-ends--> Due to the Covid pandemic, music and movement performances also occurred remotely and were seamlessly mixed live time. *CATENA* explored what the imprint of a physical space, and the bodies within it can be. 
