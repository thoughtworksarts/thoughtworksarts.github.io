...
## Dual Brains
Dual Brains is a [real-time visual performance](https://artahack.io/projects/dual-brains/) of the brain data of two performers who are wearing 3D-printed brainwave headsets. The work was incubated as part of Art-A-Hack 2016, and first performed at ThoughtWorks New York.

The work showcases shared empathy between two brains, creating a visual and sonic environment.
...
## RIOT
RIOT is an [emotionally responsive, live-action film](/blog/karen-palmer-ai-residency/) with 3D sound, which uses facial expression recognition technology to navigate through a dangerous riot in progress. In the experience, audience’s emotions are used to adjust the story of the film, so that our emotions drive the narrative of the film forwards.

{% include image.html file='riot.jpg'
   caption='The RIOT AI installation' %}

This project has been incubated as part of artist Karen Palmer’s 2017 residency at ThoughtWorks. During this time a [new version of the emotion analysis engine](https://github.com/thoughtworksarts/EmoPy) and [RIOT user experience](https://github.com/thoughtworksarts/riot) have been built from the ground up by ThoughtWorks developers.

## Suppressed Images

Suppressed Images is a [graphic short story](/projects/suppressed-images/) exploring the implications and issues around DNA, identity and genetic surveillance, and imagining what future might unfold.

The story focuses on a collaboration between the then-incarcerated whistleblower Chelsea Manning and artist Heather Dewey-Hagborg. In 2015, Chelsea sent a cheek swab from inside military prison, which Heather subjected to DNA analysis. A 3D-printed portrait was produced based on the DNA.

{% include image.html file='suppressed-images.jpg'
   caption='Suppressed Images wall-mounted prints' %}

Illustrated by ThoughtWorks graphic illustrator Shoili Kanungo, the story outlines this collaboration and explores societal and social issues surrounding the use of DNA analysis technology.

The piece was created as part of Heather’s residency at ThoughtWorks in 2016, and can be viewed online at [Suppressed Images](https://suppressedimages.net/).
...
Featured in the ThoughtWorks Arts exhibition was documentation of a major showing in a in 360-degree theatre in Hong Kong. The piece asks “Is there a place in human consciousness where surveillance cannot go?”
...
Utopia 1.0  is a [first-person expedition](https://artahack.io/projects/utopia/) to Second Life, the once thriving virtual 3D online world, in search of what remains. The film was shot ‘on location’ within Second Life by filmmaker Annie Berman.
